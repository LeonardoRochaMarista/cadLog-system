...
<body class="XXXXXXXXXXXXXXXXXXXXXX"> <!-- Define a classe com base no perfil -->
    <div class="container">
        <h1>Bem-vindo, XXXXXXXXXXXXXXXXXX !</h1>
        <p>Esta é a visão do perfil XXXXXXXXXXXXXXXXXXXX.</p>

        <?php if (): ?>
            <!-- Admin pode gerenciar usuários (editar e excluir) -->
            <a href="index.php?action=list" class="btn">Gerenciar Usuários (Admin)</a>

        <?php elseif (XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX): ?>
